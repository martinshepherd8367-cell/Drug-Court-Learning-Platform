...
export const mockUsers: User[] = [
  { id: "admin-1", role: "admin", name: "Clinical Director", email: "martin@dmsclinicalservices.com" },
  ...
  { id: "participant-1", role: "participant", name: "John Doe", email: "john.doe@example.com" },
  { id: "participant-2", role: "participant", name: "Jane Smith", email: "jane.smith@example.com" },
  { id: "participant-3", role: "participant", name: "Mike Wilson", email: "mike.wilson@example.com" },
  { id: "participant-4", role: "participant", name: "Emily Brown", email: "emily.brown@example.com" },
]
