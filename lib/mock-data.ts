import { dbtProgram } from "./dbt-loader"
import type {
  Program,
  User,
  Enrollment,
...
export const mockEnrollments: Enrollment[] = [
  {
    ...
    schedule: { day: "Monday", time: "9:00 AM", room: "Room 101", facilitatorId: "facilitator-1" }
  },
  {
    id: "enr-2",
    ...
    schedule: { day: "Wednesday", time: "6:00 PM", room: "Room 102", facilitatorId: "facilitator-1" }
  },
  {
    id: "enr-3",
    ...
    schedule: { day: "Tuesday", time: "10:30 AM", room: "Room 101", facilitatorId: "facilitator-1" }
  },
  {
    id: "enr-4",
  ...
  // Add CAT enrollment for participant-4
  {
    ...
    schedule: { day: "Thursday", time: "9:00 AM", room: "Room 103", facilitatorId: "facilitator-1" }
  },
]
